...
function ZendModuleCreator() {
    ...
    function module() {
        printf "$( cat 'QuickStartZend/templates/module.txt' )"  $moduleName $moduleName $moduleName $moduleName $moduleName $moduleName $routeName $moduleName $moduleName $moduleName
    }

    function nextStep() {
        printf "\n\n******************** NEXT STEP ********************\n"
        printf "\nOpen \"composer.json\" in your project root, and find the following section:\n\n"
